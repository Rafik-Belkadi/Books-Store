        ...
        <div class="all-service-main">
          <div class="all-service service-style">
            <ul class="service-list">
              ...
              <li><span class="service-name service-name-users"></span><p>Service après vente</p></li>
              <li><span class="service-name service-name-checkmark-circle"></span><p>Payement sécurisé</p></li>
              <li><span class="service-name service-name-bicycle"></span><p>Livraison Rapide</p></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
          <div class="category">
            <a href="<?php echo e(route('categories-page', $collection_cat_details['slug'])); ?>">
              ...
              <img class="img-responsive" src="<?php echo e($collection_cat_details['category_img_url']); ?>">
              <?php else: ?>
          ...
          <div class="single-mini-box2">
            <div class="top-cat-list-sub clearfix">
              <div class="img-div">
                ...
                <img class="img-responsive" src="<?php echo e($cat_details['cat_deails']['category_img_url']); ?>">
                <?php else: ?>
                <img class="img-responsive" src="<?php echo e(default_placeholder_img_src()); ?>">
                <?php endif; ?>
              </div>  
                ...
                <div class="hover-product">
                  <div class="hover">
                    <?php if(!empty(get_product_image($items->id))): ?> 
                      <img class="img-responsive" src="<?php echo e(get_product_image($items->id)); ?>" alt="<?php echo e(basename(get_product_image($items->id))); ?>" />
                    <?php else: ?>
                      <img class="img-responsive" src="<?php echo e(default_placeholder_img_src()); ?>" alt="" />
                    <?php endif; ?>
                    <div class="overlay">
                      <div class="overlay-content">
                        <button class="info quick-view-popup" data-id="<?php echo e($items->id); ?>">Voir les détails</button>  
                        ...
                        <ul>
                            <?php if(get_product_type( $items->id ) == 'simple_product'): ?>  
                            <li><a href="" data-id="<?php echo e($items->id); ?>" class="add-to-cart-bg" data-toggle="tooltip" data-placement="top" title="Ajouter au panier"><i class="fa fa-shopping-cart"></i></a></li>
                            <li><a href="" class="product-wishlist" data-id="<?php echo e($items->id); ?>" data-toggle="tooltip" data-placement="top" title="Ajouter à la liste de souhaits"><i class="fa fa-heart"></i></a></li>
                            <li><a href="" class="product-compare" data-id="<?php echo e($items->id); ?>" data-toggle="tooltip" data-placement="top" title="Ajouter aux comparaisons"><i class="fa fa-exchange" ></i></a></li>
                            <li><a href="<?php echo e(route('details-page', $items->post_slug )); ?>" class="product-details-view" data-toggle="tooltip" data-placement="top" title="Voir les détails"><i class="fa fa-eye"></i></a></li>
                            <?php elseif(get_product_type( $items->id ) == 'configurable_product'): ?>
  ...
  <?php endif; ?>
    ...
    <div class="row">
      <div id="latest" class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <h2> <span>Derniers produits</span></h2> 
                    ...
                    <div class="item active">
                      <div class="hover-product">
                        <div class="hover">
                          ...
                          <img class="img-responsive" src="<?php echo e(get_product_image($latest_product['id'])); ?>" alt="<?php echo e(basename(get_product_image($latest_product['id']))); ?>" />
                          <?php else: ?>
                          <img class="img-responsive" src="<?php echo e(default_placeholder_img_src()); ?>" alt="" />
                          <?php endif; ?>

                          <div class="overlay">
                            <button class="info quick-view-popup" data-id="<?php echo e($latest_product['id']); ?>">Voir les détails</button>
                          </div>
                        </div> 
                        ...
                        <div class="single-product-bottom-section">
                          ...
                          <div class="single-product-add-to-cart">
                            <?php if(get_product_type($latest_product['id']) == 'simple_product'): ?>
                              <a href="" data-id="<?php echo e($latest_product['id']); ?>" class="btn btn-sm btn-style add-to-cart-bg" data-toggle="tooltip" data-placement="top" title="Ajouter au panier"><i class="fa fa-shopping-cart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-wishlist" data-id="<?php echo e($latest_product['id']); ?>" data-toggle="tooltip" data-placement="top" title="Ajouter à la liste de souhaits"><i class="fa fa-heart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-compare" data-id="<?php echo e($latest_product['id']); ?>" data-toggle="tooltip" data-placement="top" title="Ajouter aux comparaisons"><i class="fa fa-exchange"></i></a>

                              <a href="<?php echo e(route('details-page', $latest_product['post_slug'])); ?>" class="btn btn-sm btn-style product-details-view" data-toggle="tooltip" data-placement="top" title="Voir les détails"><i class="fa fa-eye"></i></a>
      ...
      <div id="best-sales" class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <h2> <span>Meilleurs ventes</span></h2>  
        <div class="special-products-slider-control">
                    ...
                    <div class="item active">
                      <div class="hover-product">
                        <div class="hover">
                          ...
                          <img class="img-responsive" src="<?php echo e(get_product_image($best_sales_product['id'])); ?>" alt="<?php echo e(basename(get_product_image($best_sales_product['id']))); ?>" />
                          <?php else: ?>
                          <img class="img-responsive" src="<?php echo e(default_placeholder_img_src()); ?>" alt="" />
                          <?php endif; ?>

                          <div class="overlay">
                            <button class="info quick-view-popup" data-id="<?php echo e($best_sales_product['id']); ?>">Voir les détails</button>
                          </div>
                        </div> 
                        ...
                        <div class="single-product-bottom-section">
                          ...
                          <div class="single-product-add-to-cart">
                            <?php if(get_product_type($best_sales_product['id']) == 'simple_product'): ?>
                              <a href="" data-id="<?php echo e($best_sales_product['id']); ?>" class="btn btn-sm btn-style add-to-cart-bg" data-toggle="tooltip" data-placement="top" title="Ajouter au panier"><i class="fa fa-shopping-cart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-wishlist" data-id="<?php echo e($best_sales_product['id']); ?>" data-toggle="tooltip" data-placement="top" title="Ajouter à la liste de souhaits"><i class="fa fa-heart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-compare" data-id="<?php echo e($best_sales_product['id']); ?>" data-toggle="tooltip" data-placement="top" title="Ajouter aux comparaisons"><i class="fa fa-exchange"></i></a>

                              <a href="<?php echo e(route('details-page', $best_sales_product['post_slug'])); ?>" class="btn btn-sm btn-style product-details-view" data-toggle="tooltip" data-placement="top" title="Voir les détails"><i class="fa fa-eye"></i></a>
      ...
      <div id="todays-sales" class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <h2><span>Ventes d'aujourdhui</span></h2>
        <div class="special-products-slider-control">
                    ...
                    <div class="item active">
                      <div class="hover-product">
                        <div class="hover">
                          ...
                          <img class="img-responsive" src="<?php echo e(get_product_image($todays_sales_product['id'])); ?>" alt="<?php echo e(basename(get_product_image($todays_sales_product['id']))); ?>" />
                          <?php else: ?>
                          <img class="img-responsive" src="<?php echo e(default_placeholder_img_src()); ?>" alt="" />
                          <?php endif; ?>

                          <div class="overlay">
                            <button class="info quick-view-popup" data-id="<?php echo e($todays_sales_product['id']); ?>">Voir les détails</button>
                          </div>
                        </div> 
                        ...
                        <div class="single-product-bottom-section">
                          ...
                          <div class="single-product-add-to-cart">
                            <?php if(get_product_type($todays_sales_product['id']) == 'simple_product'): ?>
                              <a href="" data-id="<?php echo e($todays_sales_product['id']); ?>" class="btn btn-sm btn-style add-to-cart-bg" data-toggle="tooltip" data-placement="top" title="Ajouter au panier"><i class="fa fa-shopping-cart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-wishlist" data-id="<?php echo e($todays_sales_product['id']); ?>" data-toggle="tooltip" data-placement="top" title="Ajouter à la liste de souhaits"><i class="fa fa-heart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-compare" data-id="<?php echo e($todays_sales_product['id']); ?>" data-toggle="tooltip" data-placement="top" title="Ajouter aux comparaisons"><i class="fa fa-exchange"></i></a>

                              <a href="<?php echo e(route('details-page', $todays_sales_product['post_slug'])); ?>" class="btn btn-sm btn-style product-details-view" data-toggle="tooltip" data-placement="top" title="Voir les détails"><i class="fa fa-eye"></i></a>
                            ...
                            <?php elseif(get_product_type($todays_sales_product['id']) == 'configurable_product'): ?>
                              ...
                              <a href="" class="btn btn-md btn-style  product-wishlist" data-id="<?php echo e($todays_sales_product['id']); ?>" data-toggle="tooltip" data-placement="top" title="Ajouter à la liste de souhaits"><i class="fa fa-heart"></i></a>
    ...
    <div class="advanced-products-tab">  
      <ul class="nav nav-tabs">
        <li class="active"><a href="#featured_items" data-toggle="tab">A la une</a></li>
        <li><a href="#recommended_items" data-toggle="tab">Recommendé</a></li>
      </ul>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 extra-padding">
                      <div class="hover-product">
                        <div class="hover">
                          ...
                          <img class="img-responsive" src="<?php echo e(get_product_image($features_product['id'])); ?>" alt="<?php echo e(basename(get_product_image($features_product['id']))); ?>" />
                          <?php else: ?>
                          <img class="img-responsive" src="<?php echo e(default_placeholder_img_src()); ?>" alt="" />
                          <?php endif; ?>

                          <div class="overlay">
                            <button class="info quick-view-popup" data-id="<?php echo e($features_product['id']); ?>">Voir les détails</button>
                          </div>
                        </div> 
                        ...
                        <div class="single-product-bottom-section">
                          ...
                          <div class="single-product-add-to-cart">
                            <?php if(get_product_type($features_product['id']) == 'simple_product'): ?>
                              <a href="" data-id="<?php echo e($features_product['id']); ?>" class="btn btn-sm btn-style add-to-cart-bg" data-toggle="tooltip" data-placement="top" title="Ajouter au panier"><i class="fa fa-shopping-cart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-wishlist" data-id="<?php echo e($features_product['id']); ?>" data-toggle="tooltip" data-placement="top" title="Ajouter à la liste de souhaits"><i class="fa fa-heart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-compare" data-id="<?php echo e($features_product['id']); ?>" data-toggle="tooltip" data-placement="top" title="Ajouter aux comparaisons"><i class="fa fa-exchange"></i></a>

                              <a href="<?php echo e(route('details-page', $features_product['post_slug'])); ?>" class="btn btn-sm btn-style product-details-view" data-toggle="tooltip" data-placement="top" title="Voir les détails"><i class="fa fa-eye"></i></a>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 extra-padding">
                      <div class="hover-product">
                        <div class="hover">
                          ...
                          <img class="img-responsive" src="<?php echo e(get_product_image($recommended_product['id'])); ?>" alt="<?php echo e(basename(get_product_image($recommended_product['id']))); ?>" />
                          <?php else: ?>
                          <img class="img-responsive" src="<?php echo e(default_placeholder_img_src()); ?>" alt="" />
                          <?php endif; ?>

                          <div class="overlay">
                            <button class="info quick-view-popup" data-id="<?php echo e($recommended_product['id']); ?>">Voir les détails</button>
                          </div>
                        </div> 
                        ...
                        <div class="single-product-bottom-section">
                          ...
                          <div class="single-product-add-to-cart">
                            <?php if(get_product_type($recommended_product['id']) == 'simple_product'): ?>
                              <a href="" data-id="<?php echo e($recommended_product['id']); ?>" class="btn btn-sm btn-style add-to-cart-bg" data-toggle="tooltip" data-placement="top" title="Ajouter au panier"><i class="fa fa-shopping-cart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-wishlist" data-id="<?php echo e($recommended_product['id']); ?>" data-toggle="tooltip" data-placement="top" title="Ajouter à la liste de souhaits"><i class="fa fa-heart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-compare" data-id="<?php echo e($recommended_product['id']); ?>" data-toggle="tooltip" data-placement="top" title="Ajouter aux comparaisons"><i class="fa fa-exchange"></i></a>

                              <a href="<?php echo e(route('details-page', $recommended_product['post_slug'])); ?>" class="btn btn-sm btn-style product-details-view" data-toggle="tooltip" data-placement="top" title="Voir les détails"><i class="fa fa-eye"></i></a>
            ...
            <div class="item active">
              <div class="col-xs-12 col-sm-2 col-sm-offset-3">
                <div class="testimonials-img text-right">
                  ...
                  <img src="<?php echo e($row['testimonial_image_url']); ?>" alt="" width="170" height="169">
                  <?php else: ?>
      ...
      <div class="recent-blog-content">
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4  blog-box extra-padding">
          <a href="<?php echo e(route('blog-single-page', $rows['post_slug'])); ?>">
            ...
            <img class="img-responsive" src="<?php echo e($rows['blog_image']); ?>"  alt="<?php echo e(basename( $rows['blog_image'] )); ?>">
            <?php else: ?>
