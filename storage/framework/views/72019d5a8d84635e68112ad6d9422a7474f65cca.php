        ...
        <div id="productRightColumn" class="col-md-3 col-md-push-6">
          <div class="right-column-content">
            ...
            <div class="best-seller">
              <h2><?php echo e(trans('frontend.best_seller_label')); ?> <span class="responsive-accordian"></span></h2>
                      ...
                      <?php if($numb == 1): ?>
                        ...
                        <div class="product-content">
                          <div class="image-content">
                            ...
                            <img class="img-responsive" src="<?php echo e(get_product_image($row['id'])); ?>" alt="<?php echo e(basename(get_product_image($row['id']))); ?>" />
                            <?php else: ?>
                            <img class="img-responsive" src="<?php echo e(default_placeholder_img_src()); ?>" alt="" />
                            <?php endif; ?>
                          </div>
                          <div class="product-details">
                            <p><a href="<?php echo e(route('details-page', $row['post_slug'])); ?>"><?php echo e(get_product_title($row['id'])); ?></a></p>
            ...
            <div class="advertisement-right">
              <div id="advertisement-right-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                  <div class="item active">
                    <div class="text-center">
                      <a href=""><img src="<?php echo e(asset('resources/assets/images/add-sample/girl.jpg')); ?>" alt="" class="img-responsive" /></a>
                    </div>
                  </div>
                  <div class="item">
                    <div class="text-center">
                      <a href=""><img src="<?php echo e(asset('resources/assets/images/add-sample/sunglass.png')); ?>" alt="" class="img-responsive" /></a>
                    </div>
                  </div> 
                  <div class="item">
                    <div class="text-center">
                      <a href=""><img src="<?php echo e(asset('resources/assets/images/add-sample/mobile.png')); ?>" alt="" class="img-responsive" /></a>
                    </div>
                  </div>
                </div>
                <div class="slider-control-main text-center">
