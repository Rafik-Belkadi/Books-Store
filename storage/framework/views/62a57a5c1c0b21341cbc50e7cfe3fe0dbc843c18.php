        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            ...
            <div class="manufacturers-img-content">
              <div class="manufacturers-sample-img" <?php echo $manufacturers_logo_control['sample_img']; ?>><img class="img-responsive" src="<?php echo e(asset('public/images/upload.png')); ?>" alt=""></div>
              <div class="manufacturers-img" <?php echo $manufacturers_logo_control['manufacturers_logo']; ?>><img class="img-responsive" src="<?php echo e(asset($manufacturers_update_data['brand_logo_img_url'])); ?>" alt=""></div>
              <br>
