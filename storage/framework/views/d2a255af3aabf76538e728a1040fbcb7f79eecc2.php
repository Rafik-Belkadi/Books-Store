<div class="user-dashboard-notice">
  <h3>Salut,<?php echo e($login_user_details['user_display_name']); ?></h3>
...
<div class="row">
  <div class="col-lg-4 col-xs-12">
    <div class="small-box bg-gray">
      ...
      <a href="<?php echo e(route('my-orders-page')); ?>" class="small-box-footer">En savoir plus <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-4 col-xs-12">
    <div class="small-box bg-gray">
  ...
  <div class="col-lg-4 col-xs-12">
    <div class="small-box bg-gray">
      ...
      <a href="<?php echo e(route('my-coupons-page')); ?>" class="small-box-footer">En savoir plus <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>    
</div>
