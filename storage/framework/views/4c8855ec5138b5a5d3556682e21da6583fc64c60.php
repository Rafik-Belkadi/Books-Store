<?php $__env->startSection('update-coupon-manager-content'); ?>
    ...
    <div class="col-md-12">
      <div class="box box-info">
        <div class="box-header">
          <h3 class="box-title"><?php echo e(trans('admin.update_coupon_label')); ?> &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="<?php echo e(route('admin.coupon_manager_list')); ?>"><?php echo e(trans('admin.coupon_list_label')); ?></a></h3>
          <div class="box-tools pull-right">
            <button class="btn btn-block btn-primary" type="submit"><?php echo e(trans('admin.update')); ?></button>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="col-sm-8">
              <select name="user_role_usage_restriction" id="user_role_usage_restriction" class="form-control select2" style="width: 100%;">
                ...
                <?php if(count($user_role_list_data)> 0): ?>
                  <?php $__currentLoopData = $user_role_list_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roles): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    ...
    <div class="col-md-5">
      <div class="box box-solid">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label" for="inputUsageEndDate"><?php echo e(trans('admin.usage_range_end_date')); ?></label>
            <div class="col-sm-9">                  
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="form-group">
            <label class="col-sm-3 control-label" for="inputVisibility"><?php echo e(trans('admin.enable_coupon')); ?></label>
            <div class="col-sm-9">
