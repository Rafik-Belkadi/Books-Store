<?php $__env->startSection('art-new-category-content'); ?>
...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title"><?php echo e(trans('admin.add_new_art_category')); ?> &nbsp;&nbsp;<a class="btn btn-default btn-xs" href="<?php echo e(route('admin.art_categories_list_content')); ?>"><?php echo e(trans('admin.art_categories_lists')); ?></a></h3>
