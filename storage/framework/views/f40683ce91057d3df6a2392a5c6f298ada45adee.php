        ...
        <div id="productLeftColumn" class="col-xs-12 col-md-4">
          <div class="left-column-content">
            ...
            <div class="tags-product-list">
              <h2>Tags Populaires <span class="responsive-accordian"></span></h2>
              <div class="tag-list">
                <ul>
            ...
            <div class="brands-list">
              <h2>Notre marque <span class="responsive-accordian"></span></h2>
                        ...
                        <div class="item active">
                          <div class="col-md-12">
                            <div class="text-center">
                              ...
                              <a href="<?php echo e(route('brands-single-page', $brand_name['slug'])); ?>"><img src="<?php echo e(url('/').$brand_name['brand_logo_img_url']); ?>"></a>
                              <?php else: ?>
            ...
            <div class="advertisement">
              <h2> Publicité   <span class="responsive-accordian"></span></h2>
            ...
            <div class="filter-panel">
              <div class="filter-option-title">Filtres</div>
              <form action="<?php echo e($all_products_details['action_url']); ?>" method="get">  
                <div class="price-filter">
                  <h2>Fourchette de prix <span class="responsive-accordian"></span></h2>
                  <div class="price-slider-option">
                    ...
                    <b><?php echo e(get_current_currency_symbol(). get_appearance_settings()['general']['filter_price_min']); ?></b> <b class="pull-right"><?php echo e(get_current_currency_symbol(). get_appearance_settings()['general']['filter_price_max']); ?></b>
              ...
              <div class="col-xs-8 col-md-8">
                <div class="sort-filter-option">
                  ...
                  <select class="form-control select2 sort-by-filter" style="width:50%;">
                    ...
                    <option selected="selected" value="all">Tout voir</option>
                    <?php else: ?>
                    <option value="all">Tout voir</option>
                    <?php endif; ?>

                    <?php if($all_products_details['sort_by'] == 'alpaz'): ?>  
                    <option selected="selected" value="alpaz">A - Z</option>
                    <?php else: ?>
                    <option value="alpaz">A - Z</option>
                    <?php endif; ?>

                    <?php if($all_products_details['sort_by'] == 'alpza'): ?>  
                    <!--<option selected="selected" value="alpza">Z - A</option>-->
                    <?php else: ?>
                    <option value="alpza">Z - A</option>
                    <?php endif; ?>

                    <?php if($all_products_details['sort_by'] == 'low-high'): ?>  
                    <option selected="selected" value="low-high">Prix, min - max </option>
                    <?php else: ?>
                    <option value="low-high">Prix, min - max </option>
                    <?php endif; ?>

                    <?php if($all_products_details['sort_by'] == 'high-low'): ?>  
                    <option selected="selected" value="high-low">Prix, max - min</option>
                    <?php else: ?>
                    <option value="high-low">Prix, max - min</option>
                    <?php endif; ?>

                    <?php if($all_products_details['sort_by'] == 'old-new'): ?>  
                    <option selected="selected" value="old-new">Date, du plus nouveau</option>
                    <?php else: ?>
                    <option value="old-new">Date, du plus nouveau</option>
                    <?php endif; ?>

                    <?php if($all_products_details['sort_by'] == 'new-old'): ?>
                    <option selected="selected" value="new-old">Date, du plus ancien</option>
                    <?php else: ?>
                    <option value="new-old">Date, du plus ancien</option>
                    <?php endif; ?>
                  </select>
                </div>
              </div>    
        ...
        <div class="product-page-bottom">
          <div class="col-xs-12 col-md-6 product-bottom-bg">
            <div class="product-page-best-seller">
              <h2 class="text-center title-under">Meilleurs ventes</h2><br>
                      ...
                      <div class="product-content">
                        <div class="image-content text-center">
                          <?php if(get_product_image($row['id'])): ?>
                            <img src="<?php echo e(get_product_image($row['id'])); ?>" alt="<?php echo e(basename(get_product_image($row['id']))); ?>" />
                          <?php else: ?>
                        ...
                        <div class="product-details">
                          ...
                          <?php elseif(get_product_type($row['id']) == 'customizable_product' || get_product_type($row['id']) == 'downloadable_product'): ?>
                            ...
                            <?php endif; ?>
                          <?php endif; ?>
                          <a href="<?php echo e(route('details-page', $row['post_slug'])); ?>" class="btn btn-sm btn-style">En savoir plus</a>
                        </div>
                      </div>
          ...
          <div class="col-xs-12 col-md-6 product-bottom-bg">
            <div class="product-page-latest">
              <h2 class="text-center title-under">Nouveau</h2><br>
