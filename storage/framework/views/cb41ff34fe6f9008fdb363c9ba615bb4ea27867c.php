        ...
        <div class="dropdown language-list">
          <?php if(count(get_frontend_selected_languages_data()) > 0): ?>
            <?php if(get_frontend_selected_languages_data()['lang_code'] == 'en'): ?>
              <a class="dropdown-toggle" href="#" data-hover="dropdown" data-toggle="dropdown">
                 <span class="hidden-xs"> &nbsp; <?php echo get_frontend_selected_languages_data()['lang_name']; ?></span> <span class="caret"></span>
              </a>
            <?php else: ?>
              <a class="dropdown-toggle" href="#" data-hover="dropdown" data-toggle="dropdown">
                 <span class="hidden-xs"> &nbsp; <?php echo get_frontend_selected_languages_data()['lang_name']; ?></span> <span class="caret"></span>
            ...
            <div class="dropdown-content">
              <?php $__currentLoopData = get_available_languages_data_frontend(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <?php if($val['lang_code'] == 'en'): ?>
                  <a href="#" data-lang_name="<?php echo e($val['lang_code']); ?>"> &nbsp;<?php echo ucwords($val['lang_name']); ?></a>
                <?php else: ?>
                  <a href="#" data-lang_name="<?php echo e($val['lang_code']); ?>"> &nbsp;<?php echo ucwords($val['lang_name']); ?></a>
                <?php endif; ?>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
        ...
        <div class="clearfix">
          <div class="pull-right">
            <ul class="right-menu top-right-menu">
              ...
              <li><a href="<?php echo e(route('user-account-page')); ?>" class="main selected"><i class="fa fa-user" aria-hidden="true"></i> <span class="hidden-xs"> Mon compte</span></a></li>
              <?php else: ?>
                <li><a href="<?php echo e(route('user-account-page')); ?>" class="main"><i class="fa fa-user" aria-hidden="true"></i> <span class="hidden-xs"> Mon compte<span></a></li>
              <?php endif; ?>
      ...
      <div class="search-content">
        <div class="col-xs-12 col-sm-0 col-md-3 col-lg-3">
          <?php if(get_site_logo_image()): ?>
            <div class="logo hidden-xs hidden-sm"><img src="<?php echo e(get_site_logo_image()); ?>" alt="<?php echo e(trans('frontend.your_store_label')); ?>"></div>
          <?php endif; ?>
        </div> 
        ...
        <div class="col-xs-4 col-sm-2 col-md-3 col-lg-3 text-right"> 
          <a href="<?php echo e(route('product-comparison-page')); ?>" class="btn btn-default btn-compare"><i class="fa fa-exchange"></i> <span class="hidden-xs hidden-sm"> &nbsp; Comparer les produits</span> <span class="compare-value"> (<?php echo $total_compare_item;?>)</span></a>
        </div>  
      </div>
    </div>
          ...
          <div class="collapse navbar-collapse" id="header-navbar-collapse">
            <ul class="all-menu nav navbar-nav">
              <?php if(Request::is('home')): ?>
                <li><a href="<?php echo e(route('home-page')); ?>" class="main selected"> ACCUEIL</a></li>
              <?php else: ?>
                <li><a href="<?php echo e(route('home-page')); ?>" class="main"> ACCUEIL</a></li>
              <?php endif; ?>
                      ...
                      <ul>
                        ...
                        <?php if(isset($cat['children']) && count($cat['children']) > 0): ?>
                          <?php $__currentLoopData = $cat['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat_sub): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
														<li class="product-sub-cat22"><a href="<?php echo e(route('categories-page', $cat_sub['slug'])); ?>"><?php echo $cat_sub['name']; ?></a></li>
              ...
              <?php if(Request::is('shop')): ?>
                <li><a href="<?php echo e(route('shop-page')); ?>" class="main selected">Produits</a></li>
              <?php else: ?>
                <li><a href="<?php echo e(route('shop-page')); ?>" class="main">Produits</a></li>
              <?php endif; ?>

              <?php if(Request::is('checkout')): ?>
                <li><a href="<?php echo e(route('checkout-page')); ?>" class="main selected"> Verification du panier</a></li>
              <?php else: ?>
                <li><a href="<?php echo e(route('checkout-page')); ?>" class="main"> Verification du panier</a></li>
              <?php endif; ?>

              <?php if(Request::is('cart')): ?>
                <li><a href="<?php echo e(route('cart-page')); ?>" class="main selected"> Mon Panier</a></li>
              <?php else: ?>
                <li><a href="<?php echo e(route('cart-page')); ?>" class="main"> Mon Panier</a></li>
              <?php endif; ?>
              ...
              <li>
                <div class="dropdown custom-page">
                  <a class="dropdown-toggle" href="#" data-hover="dropdown" data-toggle="dropdown"> <?php echo trans('frontend.pages_label'); ?> 
                    <span class="caret"></span>
                  </a>
