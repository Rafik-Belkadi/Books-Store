          ...
          <div class="checkout-content">
                    ...
                    <li class="row items-inline">
                      <div class="itemName">
                        ...
                        <?php else: ?>
                          <div class="product-img">
                            <a href="<?php echo e(route('details-page', get_product_slug($items->id))); ?>">
                              <img src="<?php echo e(url('/')); ?>/public/images/no-image.png" alt="product">
                            </a>
                          </div>
                        <?php endif; ?>
                        <div class="item-name">
                ...
                <div class="login-information clearfix">
                  <div class="login-content-sub">
                    ...
                    <div class="form_content">
                      ...
                      <a class="btn btn-primary" href="<?php echo e(route('user-registration-page')); ?>">Créer un compte</a>
                    </div>
                  </div>
                  <div class="login-content-sub">
                    ...
                    <div class="form_content">
                      ...
                      <a class="btn btn-primary" href="<?php echo e(route('user-login-page')); ?>">Se connecter</a>
                    </div>
                  </div>
                </div>  
              </div>
            ...
            <div id="login_user_address" class="step well">
              ...
              <div class="text-right">
                <?php if(!empty($login_user_account_data) && !empty($login_user_account_data->address_details)): ?>
                  <a href="<?php echo e(route('my-address-edit-page')); ?>" class="btn btn-primary btn-sm">Modifier l'adresse</a>
                <?php else: ?>
                  <a href="<?php echo e(route('my-address-add-page')); ?>" class="btn btn-primary btn-sm">Ajouter une addresse</a>
                <?php endif; ?>
              </div>
              <br>
              <div class="user-address-content">
            ...
            <div id="order_notes" class="step well">
              ...
              <div class="order-extra-notes">
                <textarea name="checkout_order_extra_message" id="checkout_order_extra_message"  placeholder="Notes à propos de vos achats" class="form-control"><?php echo old('checkout_order_extra_message'); ?></textarea>
              </div>
            </div>
            <?php endif; ?>
