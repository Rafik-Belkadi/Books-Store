...
Route::put('/checkout/order-received/{order_id}/*', [
  'uses' => 'Frontend\FrontendManagerController@addTalonImage', 'as' => 'frontend-order-received-talon'
])->where('order_id', '[0-9]+');
...
Route::group(['prefix' => 'user', 'namespace' => 'Frontend'], function () {
  ...
  Route::get( 'account/notifications', [
    'uses' => 'UserAccountManageController@showNotifications',
  ...
  Route::post( 'account/view-orders-details/{user_order_id}', [
    'uses' => 'UserAccountManageController@addTalonImage',
    'as'   => 'user-order-details-talon'
  ]);
