<a href="" class="main show-mini-cart"> <span class="hidden-xs">Mon panier</span> <span class="hidden-sm hidden-md hidden-lg fa fa-shopping-cart fa-lg"></span> <span class="cart-count"><span id="total_count_by_ajax">{!! Cart::count() !!}</span></span></a>
<div id="list_popover" class="bottom">
  ...
  @if( Cart::count() >0 )
    <div id="cd-cart">
      ...
      <a href="{{ route('checkout-page') }}" class="checkout-btn">Vérifier</a>
    </div>
  @else
