...
<li class="row cart-total-main">
  ...
  <div class="cart-total-content">
      <div class="cart-sub-total"><div class="label">Total:</div><div class="value">{!! price_html( get_product_price_html_by_filter(Cart::getTotal()), get_frontend_selected_currency() ) !!}</div></div>
      <div class="cart-tax"><div class="label">{!! trans('frontend.tax') !!}:</div><div class="value">{!! price_html( get_product_price_html_by_filter(Cart::getTax()), get_frontend_selected_currency() ) !!}</div></div>
        ...
        <div class="cart-shipping-total"><div class="label">Prix de la livraison:</div><div class="value">{!! trans('frontend.free') !!}</div></div>
