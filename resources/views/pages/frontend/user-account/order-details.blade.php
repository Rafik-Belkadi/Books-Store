...
<div id="user_order_details">
  <div class="row">
    ...
    <div class="col-md-6">
       @if ($order_details_by_order_id['_payment_method'] == 'cod')
              
            @else
              
              <h4> Veuillez completer par la photo du talon et la ville de livraison </h4><hr>              
              {!! Form::open(['action' => ['Frontend\FrontendManagerController@addTalonImage', $order_details_by_order_id['order_id']], 'files' => 'true', 'method' => 'POST', 'enctype' => 'multipart/data']) !!}
                <div class="container">
                  <div class="row">
                    <div class="col-md-1">
