  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="form-group">
        <div class="col-sm-4">
          <label class="control-label" for="inputAccountTitle">{{ trans('frontend.account_title') }} (Facultatif)</label>
        </div>
        <div class="col-sm-8">
      ...
      <div class="form-group">
        <div class="col-sm-4">
          <label class="control-label" for="inputAccountCompanyName">{{ trans('frontend.account_company_name') }} (Facultatif)</label>
        </div>
        <div class="col-sm-8">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
      <div class="text-right">
          <button type="submit" class="btn btn-primary btn-sm">{{ trans('frontend.update_address') }}</button>
      </div>
    </div>
  </div>
