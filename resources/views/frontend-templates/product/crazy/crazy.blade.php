                      ...
                      <div class="product-content">
                        <div class="image-content text-center">
                          @if(get_product_image($row['id']))
                            <img src="{{ get_product_image($row['id']) }}" alt="{{ basename(get_product_image($row['id'])) }}" />
                          @else
                        ...
                        <div class="product-details">
                          ...
                          @elseif(get_product_type($row['id']) == 'customizable_product' || get_product_type($row['id']) == 'downloadable_product')
                            ...
                            @endif
                          @endif
                          <a href="{{ route('details-page', $row['post_slug'])}}" class="btn btn-sm btn-style">En savoir plus</a>
                        </div>
                      </div>
          ...
          <div class="col-xs-12 col-md-6 product-bottom-bg">
            <div class="product-page-latest">
              ...
              <div id="product-page-new-arrival" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  @foreach($advancedData['latest_items'] as $key => $row)
                    @if($numb == 1)
                      @if($flag == 1)
                        <div class="item active">
                      @else
                  ...
                  @if(!$is_last_tag_added_for_latest)
                     </div>
                  @endif 
                </div>
                <div class="slider-control-main text-center">
