        ...
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
          <div class="category">
            <a href="{{ route('categories-page', $collection_cat_details['slug']) }}">
              ...
              <img class="img-responsive" src="{{ $collection_cat_details['category_img_url'] }}">
              @else
          ...
          <div class="single-mini-box2">
            <div class="top-cat-list-sub clearfix">
              <div class="img-div">
                ...
                <img class="img-responsive" src="{{ $cat_details['cat_deails']['category_img_url'] }}">
                @else
                <img class="img-responsive" src="{{ default_placeholder_img_src() }}">
                @endif
              </div>  
                ...
                <div class="hover-product">
                  <div class="hover">
                    @if(!empty(get_product_image($items->id))) 
                      <img class="img-responsive" src="{{ get_product_image($items->id) }}" alt="{{ basename(get_product_image($items->id)) }}" />
                    @else
                      <img class="img-responsive" src="{{ default_placeholder_img_src() }}" alt="" />
                    @endif
                    <div class="overlay">
                      <div class="overlay-content">
                        <button class="info quick-view-popup" data-id="{{ $items->id }}">Voir les détails</button>  
                        ...
                        <ul>
                            @if(get_product_type( $items->id ) == 'simple_product')  
                            <li><a href="" data-id="{{ $items->id }}" class="add-to-cart-bg" data-toggle="tooltip" data-placement="top" title="Ajouter au panier"><i class="fa fa-shopping-cart"></i></a></li>
                            <li><a href="" class="product-wishlist" data-id="{{ $items->id }}" data-toggle="tooltip" data-placement="top" title="Ajouter à la liste de souhaits"><i class="fa fa-heart"></i></a></li>
                            <li><a href="" class="product-compare" data-id="{{ $items->id }}" data-toggle="tooltip" data-placement="top" title="Ajouter aux comparaisons"><i class="fa fa-exchange" ></i></a></li>
                            <li><a href="{{ route('details-page', $items->post_slug ) }}" class="product-details-view" data-toggle="tooltip" data-placement="top" title="Voir les détails"><i class="fa fa-eye"></i></a></li>
                            @elseif(get_product_type( $items->id ) == 'configurable_product')
                    ...
                    <div class="item active">
                      <div class="hover-product">
                        <div class="hover">
                          ...
                          <img class="img-responsive" src="{{ get_product_image($latest_product['id']) }}" alt="{{ basename(get_product_image($latest_product['id'])) }}" />
                          @else
                          <img class="img-responsive" src="{{ default_placeholder_img_src() }}" alt="" />
                          @endif

                          <div class="overlay">
                            <button class="info quick-view-popup" data-id="{{ $latest_product['id'] }}">Voir les détails</button>
                          </div>
                        </div> 
                        ...
                        <div class="single-product-bottom-section">
                          ...
                          <div class="single-product-add-to-cart">
                            @if(get_product_type($latest_product['id']) == 'simple_product')
                              <a href="" data-id="{{ $latest_product['id'] }}" class="btn btn-sm btn-style add-to-cart-bg" data-toggle="tooltip" data-placement="top" title="Ajouter au panier"><i class="fa fa-shopping-cart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-wishlist" data-id="{{ $latest_product['id'] }}" data-toggle="tooltip" data-placement="top" title="Ajouter à la liste de souhaits"><i class="fa fa-heart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-compare" data-id="{{ $latest_product['id'] }}" data-toggle="tooltip" data-placement="top" title="Ajouter aux comparaisons"><i class="fa fa-exchange"></i></a>

                              <a href="{{ route('details-page', $latest_product['post_slug']) }}" class="btn btn-sm btn-style product-details-view" data-toggle="tooltip" data-placement="top" title="Voir les détails"><i class="fa fa-eye"></i></a>
                    ...
                    <div class="item active">
                      <div class="hover-product">
                        <div class="hover">
                          ...
                          <img class="img-responsive" src="{{ get_product_image($best_sales_product['id']) }}" alt="{{ basename(get_product_image($best_sales_product['id'])) }}" />
                          @else
                          <img class="img-responsive" src="{{ default_placeholder_img_src() }}" alt="" />
                          @endif

                          <div class="overlay">
                            <button class="info quick-view-popup" data-id="{{ $best_sales_product['id'] }}">Voir les détails</button>
                          </div>
                        </div> 
                        ...
                        <div class="single-product-bottom-section">
                          ...
                          <div class="single-product-add-to-cart">
                            @if(get_product_type($best_sales_product['id']) == 'simple_product')
                              <a href="" data-id="{{ $best_sales_product['id'] }}" class="btn btn-sm btn-style add-to-cart-bg" data-toggle="tooltip" data-placement="top" title="Ajouter au panier"><i class="fa fa-shopping-cart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-wishlist" data-id="{{ $best_sales_product['id'] }}" data-toggle="tooltip" data-placement="top" title="Ajouter à la liste de souhaits"><i class="fa fa-heart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-compare" data-id="{{ $best_sales_product['id'] }}" data-toggle="tooltip" data-placement="top" title="Ajouter aux comparaisons"><i class="fa fa-exchange"></i></a>

                              <a href="{{ route('details-page', $best_sales_product['post_slug']) }}" class="btn btn-sm btn-style product-details-view" data-toggle="tooltip" data-placement="top" title="Voir les détails"><i class="fa fa-eye"></i></a>
                    ...
                    <div class="item active">
                      <div class="hover-product">
                        <div class="hover">
                          ...
                          <img class="img-responsive" src="{{ get_product_image($todays_sales_product['id']) }}" alt="{{ basename(get_product_image($todays_sales_product['id'])) }}" />
                          @else
                          <img class="img-responsive" src="{{ default_placeholder_img_src() }}" alt="" />
                          @endif

                          <div class="overlay">
                            <button class="info quick-view-popup" data-id="{{ $todays_sales_product['id'] }}">Voir les détails</button>
                          </div>
                        </div> 
                        ...
                        <div class="single-product-bottom-section">
                          ...
                          <div class="single-product-add-to-cart">
                            @if(get_product_type($todays_sales_product['id']) == 'simple_product')
                              <a href="" data-id="{{ $todays_sales_product['id'] }}" class="btn btn-sm btn-style add-to-cart-bg" data-toggle="tooltip" data-placement="top" title="Ajouter au panier"><i class="fa fa-shopping-cart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-wishlist" data-id="{{ $todays_sales_product['id'] }}" data-toggle="tooltip" data-placement="top" title="Ajouter à la liste de souhaits"><i class="fa fa-heart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-compare" data-id="{{ $todays_sales_product['id'] }}" data-toggle="tooltip" data-placement="top" title="Ajouter aux comparaisons"><i class="fa fa-exchange"></i></a>

                              <a href="{{ route('details-page', $todays_sales_product['post_slug']) }}" class="btn btn-sm btn-style product-details-view" data-toggle="tooltip" data-placement="top" title="Voir les détails"><i class="fa fa-eye"></i></a>
                            ...
                            @elseif(get_product_type($todays_sales_product['id']) == 'configurable_product')
                              ...
                              <a href="" class="btn btn-md btn-style  product-wishlist" data-id="{{ $todays_sales_product['id'] }}" data-toggle="tooltip" data-placement="top" title="Ajouter à la liste de souhaits"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 extra-padding">
                      <div class="hover-product">
                        <div class="hover">
                          ...
                          <img class="img-responsive" src="{{ get_product_image($features_product['id']) }}" alt="{{ basename(get_product_image($features_product['id'])) }}" />
                          @else
                          <img class="img-responsive" src="{{ default_placeholder_img_src() }}" alt="" />
                          @endif

                          <div class="overlay">
                            <button class="info quick-view-popup" data-id="{{ $features_product['id'] }}">Voir les détails</button>
                          </div>
                        </div> 
                        ...
                        <div class="single-product-bottom-section">
                          ...
                          <div class="single-product-add-to-cart">
                            @if(get_product_type($features_product['id']) == 'simple_product')
                              <a href="" data-id="{{ $features_product['id'] }}" class="btn btn-sm btn-style add-to-cart-bg" data-toggle="tooltip" data-placement="top" title="Ajouter au panier"><i class="fa fa-shopping-cart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-wishlist" data-id="{{ $features_product['id'] }}" data-toggle="tooltip" data-placement="top" title="Ajouter à la liste de souhaits"><i class="fa fa-heart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-compare" data-id="{{ $features_product['id'] }}" data-toggle="tooltip" data-placement="top" title="Ajouter aux comparaisons"><i class="fa fa-exchange"></i></a>

                              <a href="{{ route('details-page', $features_product['post_slug']) }}" class="btn btn-sm btn-style product-details-view" data-toggle="tooltip" data-placement="top" title="Voir les détails"><i class="fa fa-eye"></i></a>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 extra-padding">
                      <div class="hover-product">
                        <div class="hover">
                          ...
                          <img class="img-responsive" src="{{ get_product_image($recommended_product['id']) }}" alt="{{ basename(get_product_image($recommended_product['id'])) }}" />
                          @else
                          <img class="img-responsive" src="{{ default_placeholder_img_src() }}" alt="" />
                          @endif

                          <div class="overlay">
                            <button class="info quick-view-popup" data-id="{{ $recommended_product['id'] }}">Voir les détails</button>
                          </div>
                        </div> 
                        ...
                        <div class="single-product-bottom-section">
                          ...
                          <div class="single-product-add-to-cart">
                            @if(get_product_type($recommended_product['id']) == 'simple_product')
                              <a href="" data-id="{{ $recommended_product['id'] }}" class="btn btn-sm btn-style add-to-cart-bg" data-toggle="tooltip" data-placement="top" title="Ajouter au panier"><i class="fa fa-shopping-cart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-wishlist" data-id="{{ $recommended_product['id'] }}" data-toggle="tooltip" data-placement="top" title="Ajouter à la liste de souhaits"><i class="fa fa-heart"></i></a>
                              <a href="" class="btn btn-sm btn-style product-compare" data-id="{{ $recommended_product['id'] }}" data-toggle="tooltip" data-placement="top" title="Ajouter aux comparaisons"><i class="fa fa-exchange"></i></a>

                              <a href="{{ route('details-page', $recommended_product['post_slug']) }}" class="btn btn-sm btn-style product-details-view" data-toggle="tooltip" data-placement="top" title="Voir les détails"><i class="fa fa-eye"></i></a>
      ...
      <div class="recent-blog-content">
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4  blog-box extra-padding">
          <a href="{{ route('blog-single-page', $rows['post_slug'])}}">
            @if($rows['blog_image'])
            <img class="img-responsive" src="{{ $rows['blog_image'] }}"  alt="{{basename( $rows['blog_image'] )}}">
            @else
