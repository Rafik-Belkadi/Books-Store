...
use shopist\Models\Notification;
use Carbon\Carbon;
...
class UserAccountManageController extends Controller
{
  ...
  public function goToDifferentPages($params = null, $params2 = null)
  {
    ...
    if( isset($getRoutePrefix) && $getRoutePrefix == 'user' && !Session::has('shopist_frontend_user_id') ){
      ...
      if(Request::is('user/account/my-orders')){
      ...
      $notificationsLength = count(Notification::all());
      $this->frontendUserData['notifications_length'] = $notificationsLength;
  ...
  public function showNotifications(){
    ...
    return view('pages.frontend.user-account.user-notifications')->with('notifications', $notifications);
  }
